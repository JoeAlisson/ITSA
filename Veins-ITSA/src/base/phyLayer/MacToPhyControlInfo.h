...
public:
     ...
     */
    static cObject * const setControlInfo(cMessage * const pMsg,
            Signal * const pSignal) {
        MacToPhyControlInfo * const cCtrlInfo = new MacToPhyControlInfo(
                pSignal);
    ...
    static Signal * const getSignalFromControlInfo(cObject * const pCtrlInfo) {
        MacToPhyControlInfo * const cCtrlInfo =
                dynamic_cast<MacToPhyControlInfo * const >(pCtrlInfo);
