...
WaveShortMessage* BaseWaveApplLayer::prepareWSM(std::string name, int lengthBits, t_channel channel,
    ...
    if (name == "beacon") {
        DBG << "CRIANDO MSG DE " << myId << " com dados " << wsm->getWsmData() << std::endl;
    }
    if (name == "data") {
