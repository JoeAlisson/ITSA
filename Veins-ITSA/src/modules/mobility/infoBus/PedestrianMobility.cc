...
void PedestrianMobility::preInitialize(int external_id, const Coord& position, std::string road_id, double speed, double angle) {
...
void PedestrianMobility::nextPosition(const Coord& position, std::string road_id,
